...
export default function TripMap({ tripId }: TripMapProps) {
  ...
  if (isError) {
    return (
      <section className="px-6 pb-16">
        <div className="mx-auto max-w-6xl rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-600">
  ...
  return (
    <section className="px-6 pb-16">
      <div className="mx-auto max-w-6xl">
        <h2 className="mb-4 text-2xl font-semibold text-velvet-green">Map & Nearby Highlights</h2>
        <MapContainer
